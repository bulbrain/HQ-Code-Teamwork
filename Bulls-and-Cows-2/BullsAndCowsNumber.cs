    ...
    public class BullsAndCowsNumber
    {
        ...
        public string GetCheat()
        {
            if (this.Cheats < 4)
            {
                while (true)
                {
                    int randPossition = this.rrr.Next(0, 4);
        ...
        {
            this.FirstDigit = this.rrr.Next(0, 10);
            this.SecondDigit = this.rrr.Next(0, 10);
            this.ThirdDigit = this.rrr.Next(0, 10);
            this.FourthDigit = this.rrr.Next(0, 10);
        }
    }
}
